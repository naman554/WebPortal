...
<div id="section">
  ...
  echo '<table  width="40%" id="notice" bgcolor="white"  class="student">';
       
         
              $a=mysql_query("SELECT * FROM newrequests WHERE id='$id'");
       ...
       echo '</table>';
?>
       <a href="adminpanel.php" style="color:white;padding-left: 50px;">Go back?</a>
